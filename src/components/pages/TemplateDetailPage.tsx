...
import { ArrowRight, Zap, Monitor, Tablet, Smartphone, ChevronDown, Check, X } from 'lucide-react';
    ...
    <div className="fixed inset-0 z-[100] bg-[#050505] flex flex-col overflow-hidden animate-in fade-in duration-300">
      ...
      <header className="h-20 bg-background/80 backdrop-blur-md border-b border-white/10 px-6 flex items-center justify-between z-10 shrink-0">
        ...
        <div className="relative group">
          <button className="clip-edge bg-primary text-primary-foreground font-bold px-6 py-3 flex items-center gap-3 hover:bg-primary/90 transition-all shadow-[0_0_20px_rgba(0,255,204,0.2)]">
      ...
      <main className="flex-1 bg-[#151515] relative overflow-hidden flex justify-center">
        ...
        <motion.div 
          ...
          className="h-full bg-white shadow-2xl relative overflow-hidden shadow-primary/5"
        >
          <iframe 
